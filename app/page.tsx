...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const data = await res.json() as { error?: string; success?: boolean; user?: { role: string } };
      if (!res.ok) {
      ...
      <div className="relative z-10 mx-4 w-full max-w-sm rounded-xl border bg-background/80 p-8 shadow-lg backdrop-blur-sm sm:mx-0">
        <div className="mx-auto w-full">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Log in to your account to save your progress and to sync it on
            another devices.
          </p>
          ...
          <form className="mt-6 space-y-4" onSubmit={handleLogin}>
            <div>
              ...
              <Input
                ...
                className="h-11 rounded-full border-border bg-background px-4 text-sm"
              />
            </div>
            <div className="relative">
              ...
              <Input
                ...
                className="h-11 rounded-full border-border bg-background px-4 pr-10 text-sm"
              />
              <button
                type="button"
          ...
          <p className="mt-6 text-center text-[10px] text-muted-foreground">
            By continuing you agree profile{" "}
